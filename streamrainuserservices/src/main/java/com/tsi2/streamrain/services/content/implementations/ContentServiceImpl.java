...
import com.tsi2.streamrain.bussines.content.implementations.DAOContentBussinesImpl;
...
public class ContentServiceImpl implements IContentService{
	...
	public boolean saveContent(final ContentDto content, final String tenantID) {
		IDAOContentBussines daoService = (DAOContentBussinesImpl) StremRainUserBussinesContextLoader.contextLoader().getBean("contentBussines");
