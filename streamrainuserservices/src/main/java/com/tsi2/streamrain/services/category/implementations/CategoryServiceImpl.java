...
import com.tsi2.streamrain.context.StremRainCategoryBussinesContextLoader;
...
public class CategoryServiceImpl implements ICategoryService {
	...
	public boolean saveCategory(final CategoryDto c, final String tenantID) {
		IDAOCategoryBussines daoService = (DAOCategoryBussinesImpl) StremRainCategoryBussinesContextLoader.contextLoader().getBean("categoryBussines");
