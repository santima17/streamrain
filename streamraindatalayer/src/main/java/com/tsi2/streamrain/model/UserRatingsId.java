...
/**
 * UserRatingsId generated by hbm2java
 */
public class UserRatingsId  implements java.io.Serializable {
    ...
    public UserRatingsId(int userId, int contentId, Date date) {
       this.userId = userId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UserRatingsId) ) return false;
		 UserRatingsId castOther = ( UserRatingsId ) other; 
